...
Перейти к Шагу 7.46: добавить verify-check для logout с уже ревокнутым/устаревшим refresh token, чтобы операция оставалась идемпотентной и не затрагивала активную сессию.
