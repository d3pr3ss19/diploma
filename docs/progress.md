...
Перейти к Шагу 8.6: пройти dry-run роли ADMIN (создание/редактирование абонента, создание заявки через выбор абонента/счёта) и зафиксировать результаты в release-checklist.
