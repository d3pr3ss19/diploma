...
for target in smoke smoke-full smoke-backend smoke-frontend e2e-api e2e-rbac verify-scripts verify-structure verify-configs verify-token-helper verify-tooling test-frontend; do
